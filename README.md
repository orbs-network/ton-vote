...
2. Manually transfer 0.01 TON to the contract address EQDOpqfdHHfB0YvPqPupyPnA8HHF0V1aoDaZEStO1fG0nzdb and include a comment with your vote, specifying the numbers of the selected projects. You may format the comment by either separating the numbers with commas or with spaces, such as "1, 2, 5, 7, 9" or "1 2 5 7 9".

3. Open the relevant ton:// deep link with a supporting wallet: `ton://transfer/EQDOpqfdHHfB0YvPqPupyPnA8HHF0V1aoDaZEStO1fG0nzdb?amount=10000000&text=1, 2, 5, 7, 9`
...
1. Votes are sent as on-chain transactions to a smart contract on mainnet: https://tonscan.org/address/EQDOpqfdHHfB0YvPqPupyPnA8HHF0V1aoDaZEStO1fG0nzdb

2. You can open this contract in an explorer and see all transactions sent to it with their votes as comments. You can also see the contract code since it is [verified](https://verifier.ton.org/EQDOpqfdHHfB0YvPqPupyPnA8HHF0V1aoDaZEStO1fG0nzdb). The source includes parameters of the vote like start and end time.
